...
Status: implemented on `codex/native-personas-workflow`; release validation is recorded in [native end-to-end checks](../native-end-to-end.md). Updated September 11, 2026. The optional AI character generator and later expansions remain deferred. Use the shipped [persona controls](../personas.md), [native workflow](../native-workflow.md), and [command reports](../command-reports.md) guides for current commands and limits.
