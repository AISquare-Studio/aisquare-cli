...
| `shift+enter` | `S-Enter` (tmux ≥ 3.5; below, refused with a warning naming the version it needs — 3.3/3.4 mistype it) | anything else unspellable | dropped, one quiet line |
