...
| `docs/xr-demo.md` exists and has been rehearsed twice | **desktop done · headset pending** | This document; rehearsed twice end to end on the desktop, including the recovery drill. The headset rehearsal is **M9 and has not happened**. |
