...
- confirm=true on stop, spawn and restart only when the owner asked and their words name the agent, its role or its project. Else ask "stop coder-01 in alpha?"; their yes confirms.
