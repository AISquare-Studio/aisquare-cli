...
def test_the_spawn_note_names_a_step_a_restart_or_a_switch_receipt_can_follow(
    ...
    the note rides on their receipts too, and ``fleet spawn``'s ``--permission-mode`` —
    the remedy it used to give — is a usage error there. The note names the ROLE's step,
